...
```{r}
source("funciones-r/infoBogota.R", encoding = "UTF-8")
source("funciones-r/infoMedellin.R", encoding = "UTF-8")
source("funciones-r/infoCali.R", encoding = "UTF-8")
source("funciones-r/infoBquilla.R", encoding = "UTF-8")
source("funciones-r/infoCartagena.R", encoding = "UTF-8")
source("funciones-r/infoBucaramanga.R", encoding = "UTF-8")
```
